...
- **Ops-friendly** — tersedia skrip `init_db.py`, CLI dashboard (`dashboard/cli.py`), serta contoh unit `systemd` dan Nginx.
...
- `db.py` & `init_db.py` – koneksi dan bootstrap PostgreSQL.
