...
def initialize_main_schemas():
    ...
    try:
        ...
        print(
            "      - chat_logs (+channel), bullying_reports, psych_reports, web_users, telegram_users, whatsapp_users, corruption_reports, twitter_worker_logs"
        )
...
def initialize_dashboard_schemas():
    ...
    try:
        ...
        print(
            "      - Memperbarui tabel 'bullying_reports' dengan kolom dan constraint terbaru."
        )

    except ImportError as e:
        print(
            f"   -> Gagal: Tidak dapat mengimpor modul dashboard. Pastikan struktur direktori benar.",
            file=sys.stderr,
        )
...
if __name__ == "__main__":
    ...
    print("========================================")
    print(
        "Skrip ini akan memeriksa dan membuat semua tabel, kolom, dan indeks yang diperlukan untuk proyek.\n"
    )
    ...
    try:
        ...
        if not os.path.exists(".env"):
            print(
                "PERINGATAN: File .env tidak ditemukan. Koneksi database mungkin gagal.",
                file=sys.stderr,
            )
            print(
                "Pastikan Anda telah menyalin .env.template ke .env dan mengisinya.\n",
                file=sys.stderr,
            )
        ...
        print(
            "Satu atau lebih langkah inisialisasi database gagal. Silakan periksa log error di atas.",
            file=sys.stderr,
        )
