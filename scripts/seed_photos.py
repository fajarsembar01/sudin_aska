...
def seed_photos():
    with app.app_context():
        with get_cursor(commit=True) as cur:
            ...
            if not records:
                print(
                    "No submitted/verified assessments found. Run `python -m scripts.seed_dummy` first."
                )
                return
            ...
            for rec in records:
                ...
                """,
                    (
                        ...
                        random.randint(
                            0, 30
                        ),  # Random capture date within last 30 days
                    ),
                )
                photo_count += 1
            ...
            print(
                f"Successfully inserted/updated {photo_count} photos and {score_count} scores!"
            )
