    ...
    with get_cursor(commit=True) as cur:
        ...
        pks = [
            ...
            (
                ...
                "laporan_submission_answers_pkey",
                "PRIMARY KEY (id)",
            ),
            (
                "laporan_submission_files",
                "laporan_submission_files_pkey",
                "PRIMARY KEY (id)",
            ),
        ]
        ...
        fks = [
            (
                "laporan_form_fields",
                "fk_laporan_fields_form",
                "FOREIGN KEY (form_id) REFERENCES laporan_forms(id) ON DELETE CASCADE",
            ),
            (
                "laporan_submissions",
                "fk_laporan_submissions_form",
                "FOREIGN KEY (form_id) REFERENCES laporan_forms(id) ON DELETE CASCADE",
            ),
            (
                "laporan_submissions",
                "fk_laporan_submissions_school",
                "FOREIGN KEY (school_id) REFERENCES portal_schools(id) ON DELETE CASCADE",
            ),
            (
                "laporan_submission_answers",
                "fk_laporan_answers_submission",
                "FOREIGN KEY (submission_id) REFERENCES laporan_submissions(id) ON DELETE CASCADE",
            ),
            (
                "laporan_submission_answers",
                "fk_laporan_answers_field",
                "FOREIGN KEY (field_id) REFERENCES laporan_form_fields(id) ON DELETE CASCADE",
            ),
            (
                "laporan_submission_files",
                "fk_laporan_files_answer",
                "FOREIGN KEY (answer_id) REFERENCES laporan_submission_answers(id) ON DELETE CASCADE",
            ),
        ]
