...
def run_migration():
    ...
    try:
        ...
        cur.execute("ALTER TABLE monev_teams ADD COLUMN IF NOT EXISTS team_type VARCHAR(20) DEFAULT 'kecamatan'")
        ...
        cur.execute("UPDATE monev_teams SET team_type = 'kecamatan' WHERE kecamatan_id IS NOT NULL")
        ...
        # Verify results
        cur.execute("SELECT id, team_type, name, kecamatan_id FROM monev_teams ORDER BY team_type, id")
        teams = cur.fetchall()
